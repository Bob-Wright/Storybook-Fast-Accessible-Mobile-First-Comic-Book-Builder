...
//require "/home/bitnami/ArtSee/htdocs/Login.php";
...
$head2 = <<< EOT2
	...
	<base href="https://syntheticreality.net/ArtSee/">
...
<img id="shareButton" src="https://syntheticreality.net/ArtSee/Images/facebook-share-gallery-button.png">

<!-- logout of gallery share button -->
<div id="logoutButton"><a id="logoutButtonURL" href="https://syntheticreality.net/GalleryBuilder/closeGalleryBuilder.php"><img src="https://syntheticreality.net/ArtSee/Images/facebook-logout-button.png"></a></div>
BODY1;
echo $body1;
...
// Logout of Artsee AND Facebook button
...
<?php
	...
	'</div>'.
	'<footer id="myFooter">'.
	'<div id="galleryFooter"><a id="prevpagebutton" href="../GalleryBuilder.php">❮ Previous</a>&emsp;&copy; 2020 by&nbsp;<span class="mdi mdi-email"></span>&nbsp;<a href="mailto:itzbobwright@gmail.com">Bob Wright.</a>&nbsp;Last modified ';

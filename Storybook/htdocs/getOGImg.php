...
<form name="form_id" id="form_id" action="javascript:void(0);" enctype="multipart/form-data">
	<label>Select and Upload an OG Image for the Comic:<br><input type="file" accept=".png,.PNG,.jpg,.JPG" name="vasplus_multiple_files" id="vasplus_multiple_files" multiple tabindex="1">
	<input type="submit" value="Upload Selected File" id="Upload" tabindex="2"></label>
</form>
<br></div>
<hr class="new4">
...
echo $head3;
	...
	'<nav id="ComicFooter"><p><a id="prevpagebutton" href="./comicFonts.php" title="return to fonts chooser" tabindex="4">❮ Previous</a>&emsp;&copy; 2020 by&nbsp;<span><svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 40.000000 40.000000" preserveAspectRatio="xMidYMid meet">
	...
	-51z"/>
		...
		echo date ("F d Y H:i.", getlastmod()).'&emsp;<a id="nextpagebutton" href="./Yield.php?saveDB=1" title="create the comic" tabindex="3">Next ❯</a></p></nav>'.
		'</footer>';
$scr = <<< SCR1
      <script>
window.onload = function() {
           $("input[type = 'submit']").click(function(){
               ...
               if (parseInt(fileUpload.get(0).files.length) > 1){
                  alert("You are only allowed to upload one Comic OG image file!");
				  window.location.replace("https://syntheticreality.net/Storybook/getOGImg.php");
               }
            });
         };
      </script>
